...
const fs = require('fs');
var F1_T00_MotionCreateDict = require('../openmct/example/F1_T00_Motion/F1_T00_MotionCreateDict');
...
function F1_T00_Motion() {
	...
	//let rawDict = fs.readFileSync('../openmct/example/F1_T00_Motion/F1_T00_Motiondictionary.json')
